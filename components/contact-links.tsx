...
export function ContactLinks({ className, compact = false }: ContactLinksProps) {
  const shared =
    "focus-bauhaus rounded-none font-mono text-xs uppercase tracking-widest";
  ...
  return (
    ...
    >
      <Button asChild className={cn(shared, "h-11 px-5")}>
      ...
      <Button
        asChild
        variant="outline"
        className={cn(shared, "h-11 border-foreground/30 px-5")}
      >
